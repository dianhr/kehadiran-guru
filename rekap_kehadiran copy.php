  ...
  <form method="GET" class="row g-3 mb-4">
    ...
    <div class="col-md-3">
      ...
      <select name="nama_guru" class="form-select">
        ...
        <?php
          $resultGuru = $conn->query("SELECT DISTINCT nama_guru FROM kehadiran_guru13 ORDER BY nama_guru");
          while ($g = $resultGuru->fetch_assoc()) {
            $selected = (isset($_GET['nama_guru']) && $_GET['nama_guru'] == $g['nama_guru']) ? 'selected' : '';
            echo "<option value='".$g['nama_guru']."' $selected>".$g['nama_guru']."</option>";
          }
        ?>
      </select>
    </div>
